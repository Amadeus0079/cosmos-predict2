...
"""
predict2_video2world_2b_multiview_training_frontview = dict(
    defaults=[
        {"override /model": "predict2_v2w_2b_multiview_fsdp_long16"},
        {"override /optimizer": "fusedadamw"},
        {"override /ckpt_type": "standard"},
        {"override /dataloader_train": "robocasa_frontview_train"},
        "_self_",
    ],
    model=dict(
        config=dict(
    ...
    job=dict(group="debug", name="frontview_${now:%Y-%m-%d}_${now:%H-%M-%S}"),
    model_parallel=dict(
...
for _item in [
    ...
    predict2_video2world_2b_multiview_training_frontview,
]:
