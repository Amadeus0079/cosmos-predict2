...
"""
predict2_video2world_2b_action_conditioned_training_concat = dict(
    defaults=[
        {"override /model": "predict2_v2w_2b_action_conditioned_fsdp_concat"},
...
for _item in [
    ...
    predict2_video2world_2b_action_conditioned_training_concat,
]:
