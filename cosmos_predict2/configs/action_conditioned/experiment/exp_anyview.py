...
"""
predict2_video2world_2b_multiview_training_anyview = dict(
    defaults=[
    ...
    job=dict(group="debug", name="anyview_${now:%Y-%m-%d}_${now:%H-%M-%S}"),
    model_parallel=dict(
...
for _item in [
    ...
    predict2_video2world_2b_multiview_training_anyview,
]:
