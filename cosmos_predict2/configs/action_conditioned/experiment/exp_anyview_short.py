...
"""
predict2_video2world_2b_multiview_training_anyview_short = dict(
    defaults=[
        {"override /model": "predict2_v2w_2b_multiview_fsdp_concat"},
        {"override /optimizer": "fusedadamw"},
        {"override /ckpt_type": "standard"},
        {"override /dataloader_train": "robocasa_anyview_train"},
        "_self_",
    ],
    model=dict(
        config=dict(
    ...
    job=dict(group="debug", name="anyview_short_${now:%Y-%m-%d}_${now:%H-%M-%S}"),
    model_parallel=dict(
...
for _item in [
    ...
    predict2_video2world_2b_multiview_training_anyview_short,
]:
