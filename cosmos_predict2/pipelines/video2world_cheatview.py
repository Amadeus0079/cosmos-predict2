...
class Video2WorldCheatviewPipeline(Video2WorldActionConditionedPipeline):
    ...
    def process(
        ...
        #     torchvision.io.write_video(f"/inspire/hdd/project/robot-reasoning/xiangyushun-p-xiangyushun/zichen/output/picos/robo{b}.mp4", ((right_video[b] + 1) / 2 * 255).to(torch.uint8), fps=1)
