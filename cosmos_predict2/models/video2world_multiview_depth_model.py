...
from cosmos_predict2.pipelines.video2world_multiview_depth import Video2WorldMultiviewDepthPipeline
from imaginaire.model import ImaginaireModel
from imaginaire.utils import log


class Predict2Video2WorldMultiviewDepthModel(Predict2Video2WorldActionConditionedModel):
    def __init__(self, config: Predict2Video2WorldModelConfig):
        ...
        self.pipe = Video2WorldMultiviewDepthPipeline.from_config(
            config.pipe_config,
