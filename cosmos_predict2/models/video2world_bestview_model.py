...
from cosmos_predict2.pipelines.video2world_bestview import Video2WorldBestviewPipeline
from imaginaire.model import ImaginaireModel
from imaginaire.utils import log


class Predict2Video2WorldBestviewModel(Predict2Video2WorldActionConditionedModel):
    def __init__(self, config: Predict2Video2WorldModelConfig):
        ...
        self.pipe = Video2WorldBestviewPipeline.from_config(
            config.pipe_config,
